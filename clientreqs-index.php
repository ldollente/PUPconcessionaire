...
{
    $did = $_GET['delid'];
    $stmt = $con->prepare("CALL delete_client_requirements(?)");
    $stmt->bind_param("i", $did);
    $stmt->execute();

    echo "<script>alert('Deleted successfully!');</script>";
    echo "<script>window.location='clientreqs-index.php';</script>";
}
?>
...
<html lang="en">
    ...
    <div> 
        ...
        <div class="row">
            <div class="col-md-12">
                <div>
                <form action="clientreqs-index.php" method="post"style="margin-top:50px;">
                    <input
                        type="text"
                    ...
                    <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $sql = "SELECT * FROM client_requirements WHERE client_id LIKE ?";
                                ...
                                echo '<table class="table table-bordered table-striped">';
                                    echo "<thead>";
                                        echo "<tr>";
                                            ...
                                            echo "<th>Health Clearance</th>";
                                            echo "<th>Mayor's Permit</th>";
                                            echo "<th>BIR</th>";
                                            echo "<th>SSS</th>";
                                    ...
                                    while($row = $result->fetch_array()){
                                        echo "<tr>";
                                            ...
                                            echo "<td>" . $row['health_clr'] . "</td>";
                                            echo "<td>" . $row['mayors_prm'] . "</td>";
                                            echo "<td>" . $row['bir'] . "</td>";
                                            echo "<td>" . $row['sss'] . "</td>";
                                            echo "<td>" . $row['philhealth'] . "</td>";
                                            echo "<td>" . $row['pag_ibig'] . "</td>";
                                            echo "<td>";
                                                echo '<a href="update-clientreqs.php?id='. $row['client_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                                echo '<a href="clientreqs-index.php?id='. $row['client_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";                            
            ...
            <div class="col-md-12">
                ...
                <thead style='background-color: maroon; color: white;' >
                        ...
                        <tbody>
                            <?php
                                require_once "config.php";
                                $sql = mysqli_query($con, "SELECT * FROM `client_requirements`");
                                    $count = 1;
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="update-clientreqs.php?editid=<?php echo htmlentities($row['client_id']);?>" class="link-dark" class="mr-3" title="Update Record" data-toggle="tooltip"><span style="font-size: 23px; color: #00ACC1;" class="fa fa-pencil"></span></a>
                                    <a href="clientreqs-index.php?delid=<?php echo htmlentities($row['client_id']);?>" class="link-dark" title="Delete Record" data-toggle="tooltip"><span style="font-size: 23px; color: #00ACC1;" class="fa fa-trash"></span></a>
                                </td>
                            </tr>
                            <?php
                                        $count = $count+1;
