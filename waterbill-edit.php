...
if(isset($_POST['update']))
{
    ...
    $stmt = mysqli_prepare($con, "CALL update_water_bill(?, ?, ?, ?)");
    ...
    $message = mysqli_fetch_row($result)[0];

    // Display the result message and redirect
    echo "<script>alert('$message');</script>";
    echo "<script>document.location = 'waterbill-index.php';</script>";
}
...
<html lang="en">
  ...
  <div class="topnav" id="myTopnav">
    ...
    <h2>Water Bill Information</h2>
                ...
                <?php 
                    $eid = $_GET['editid'];
                    $sql = mysqli_query($con, "SELECT * FROM  `water_bill` WHERE bill_id = '$eid'");
...
<div class='form_buttons' >
                    ...
                    <button>
                    <a class='cancel' href="waterbill-index.php" class="btn btn-danger">Cancel</a>
                    </button>
                </div>
            </form>
        </div>
