...
<html lang="en">
    ...
    <div> 
        ...
        <div class="col-md-12">
            <div>
                <form action="waterbill-index.php" method="post" style="margin-top:50px;">
                    <input
                        type="text"
                    ...
                    <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $sql = "SELECT * FROM water_bill WHERE bill_id LIKE ?";
                                ...
                                echo '<table class="table table-bordered table-striped">';
                                    ...
                                    while($row = $result->fetch_array()){
                                        echo "<tr>";
                                            ...
                                            echo "<td>";
                                                echo '<a href="waterbill-edit.php?id='. $row['client_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";                            
                ...
                <h2 class="pull-left">List of Water Bill Records</h2>
            </div>
        </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-light table-striped text-center" style="padding:10px">
                        ...
                        <tbody>
                            <?php
                                require_once "config.php";
                                $sql = mysqli_query($con, "SELECT * FROM `water_bill`");
                                    $count = 1;
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="waterbill-edit.php?editid=<?php echo htmlentities($row['bill_id']);?>" class="link-dark" class="mr-3" title="Update Record" data-toggle="tooltip"><span style="font-size: 23px; color: #00ACC1;" class="fa fa-pencil"></span></a>
                                </td>
                            </tr>
                            <?php
                                        $count = $count+1;
