...
if(isset($_POST['submit']))
{
    ...
    $stmt = $con->prepare("CALL insert_space_bill(?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssdddd",$bill_id ,$client_id, $space_id, $rent_bill, $misc_bill, $penalty, $security_dep);
    if($stmt->execute())
    {
        echo "<script>alert('New Space successfully added!');</script>";
        echo "<script>document.location = 'spacebill-add_new.php';</script>";
    }
    else
    {
            ...
            <h2>Space Bill Information</h2>
                <div class='form_group' class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="bill_id" placeholder="BL001">
                    </div>
                </div>
                <div class='form_group' class="row mb-3">
                    <div class="col">
                        <label class="form-label">Client ID</label>
                        <input type="text" class="form-control" name="client_id" placeholder="C001">
                    </div>
                </div>
                <div class='form_group' class="row mb-3">
                    <div class="col">
                ...
                <div class='form_group' class="row mb-3">
                    ...
                    <div class="col">
                        ...
                        <input type="number" class="form-control" name="rent_bill" step=".01" placeholder="5000">
                    </div>

                    <div class="col">
                        <label class="form-label">Miscellaneous Fee</label>
                        <input type="number" class="form-control" name="misc_bill" step=".01" placeholder="5000">
                    </div>
                ...
                <div class='form_group' class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <input type="number" class="form-control" name="penalty" step=".01" placeholder="5000">
                        </div>

                        <div class="col">
                            <label class="form-label">Security Deposit</label>
                            <input type="number" class="form-control" name="security_dep" step=".01" placeholder="5000">
                        </div>
                ...
                <div class='form_buttons'>
                    ...
                    <button>
                    <a class='cancel' href="spacebill-index.php" class="btn btn-danger">View Records</a>
                    </button>
                </div>
