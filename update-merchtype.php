...
if(isset($_POST['update']))
{
    ...
    $stmt = $con->prepare("CALL update_merch_type(?, ?)");
    $stmt->bind_param("is", $eid, $merch_type);
    $stmt->execute();
  ...
  <div class="topnav" id="myTopnav">
    ...
    <div class='profile_form' class="container d-flex justify-content-center"  class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            ...
            <h2>Merchandise Type Information</h2>
                <?php 
                    $eid = $_GET['editid'];
                    $sql = mysqli_query($con, "SELECT * FROM  `merch_type` WHERE merch_id = '$eid'");
                ...
                <div class='form_group' class="row mb-3">
                    <div class="col">
                        <label class="form-label">Merch Type</label>
                        <input type="text" class="form-control" name="merch_type">
                    </div>
                </div>
                ...
                <div class='form_buttons'>
                    ...
                    <button>
                    <a class='cancel' href="merchtype-index.php" class="btn btn-danger">Cancel</a>
                    </button>
                </div>
            </form>
    </div>
