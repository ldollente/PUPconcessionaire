...
<html lang="en">
    ...
    <div> 
        ...
        <div class="col-md-12">
                <div>
                <form action="spacebill-index.php" method="post" style="margin-top:50px;">
                    <input
                        type="text"
                    ...
                    <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $sql = "SELECT * FROM space_bill WHERE bill_id LIKE ?";
                                ...
                                echo '<table class="table table-bordered table-striped">';
                                    echo "<thead>";
                                        echo "<tr>";
                                            ...
                                            echo "<th>Penalty Fee</th>";
                                            echo "<th>Security Deposit</th>";
                                            echo "<th>Space Bill</th>";
                                            echo "<th>Action</th>";
                                        echo "</tr>";
                                    echo "</thead>";
                                    echo "<tbody>";
                                    while($row = $result->fetch_array()){
                                        echo "<tr>";
                                            ...
                                            echo "<td>" . $row['rent_bill'] . "</td>";
                                            echo "<td>" . $row['misc_bill'] . "</td>";
                                            echo "<td>" . $row['penalty'] . "</td>";
                                            echo "<td>" . $row['security_dep'] . "</td>";
                                            echo "<td>" . $row['space_bill'] . "</td>";
                                            echo "<td>";
                                                echo '<a href="spacebill-edit.php?id='. $row['bill_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";                            
                ...
                <h2 class="pull-left">Space Bill</h2>
                <a href="spacebill-add_new.php" class="btn btn-info pull-right" style="padding:10px; color: white;"><i class="fa fa-plus" style="font-size: 18px;"></i> Add Bill</a>
                </div>
        </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-light table-striped text-center" style="padding:10px">
                        ...
                        <tbody>
                            <?php
                                require_once "config.php";
                                $sql = mysqli_query($con, "SELECT * FROM `space_bill`");
                                    $count = 1;
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['misc_bill'];?></td>
                                <td><?php echo $row['penalty'];?></td>
                                <td><?php echo $row['security_dep'];?></td>
                                <td><?php echo $row['space_bill'];?></td>              
                                <td>
                                    <a href="spacebill-edit.php?editid=<?php echo htmlentities($row['bill_id']);?>" class="link-dark" class="mr-3" title="Update Record" data-toggle="tooltip"><span style="font-size: 23px; color: #00ACC1;" class="fa fa-pencil"></span></a>
                                </td>
                            </tr>
                            <?php
                                        $count = $count+1;
