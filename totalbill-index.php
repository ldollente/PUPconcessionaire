...
<html lang="en">
    ...
    <div> 
        ...
        <div class="col-md-12">
                <div>
                <form action="totalbill-index.php" method="post" style="margin-top:50px;">
                    <input
                        type="text"
                        placeholder="Search total bill"
                        name="search"
                        required>
                    ...
                    <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $sql = "SELECT * FROM total_bill WHERE bill_id LIKE ? or space_id LIKE ? or client_id LIKE? ";

                            // Prepare, bind, and execute the query
                            $prepared_stmt = $connection_string->prepare($sql);
                            $prepared_stmt->bind_param('sss', $searchString,$searchString,$searchString);
                                ...
                                echo '<table class="table table-bordered table-striped">';
                                    ...
                                    while($row = $result->fetch_array()){
                                        echo "<tr>";
                                            ...
                                            echo "<td>" . $row['e_bill'] . "</td>";
                                            echo "<td>" . $row['w_bill'] . "</td>";
                                            echo "<td>" . $row['s_bill'] . "</td>";
                                            echo "<td>" . $row['due_date'] . "</td>";
                                            echo "<td>" . $row['total_bill'] . "</td>";
                                            echo "<td>";
                                                echo '<a href="totalbill-edit.php?id='. $row['bill_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";                            
                ...
                <h2 class="pull-left">Total Bill</h2>
            </div>
        </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-light table-striped text-center" style="padding:10px">
                        ...
                        <tbody>
                            <?php
                                require_once "config.php";
                                $sql = mysqli_query($con, "SELECT * FROM `total_bill`");
                                    $count = 1;
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['e_bill'];?></td>
                                <td><?php echo $row['w_bill'];?></td>   
                                <td><?php echo $row['s_bill'];?></td>   
                                <td><?php echo $row['due_date'];?></td>   
                                <td><?php echo $row['total_bill'];?></td>                  
                                <td>
                                    <a href="totalbill-edit.php?editid=<?php echo htmlentities($row['bill_id']);?>" class="link-dark" class="mr-3" title="Update Record" data-toggle="tooltip"><span style="font-size: 23px; color: #00ACC1;" class="fa fa-pencil"></span></a>
                                </td>
                            </tr>
                            <?php
                                        $count = $count+1;
