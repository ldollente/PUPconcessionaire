...
<body>
    <div class="topnav" id="myTopnav">
        ...
        <a href="read-assignedspace-client.php">My Spaces</a>
        <a href="read-clientreqs-client.php">Requirements</a>
    ...
    <div class='profile_form'>
        ...
        <h2>Change Password</h2>
            ...
            <button class='save' value="submit" type='submit'>Save</button>
                <button>
                <a class="btn btn-link ml-2" href="user-dashboard.php">Cancel</a>
                </button>
            </div>
        </form>
    </div>    
