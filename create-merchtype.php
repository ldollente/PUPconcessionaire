...
if(isset($_POST['submit']))
{
    ...
    $stmt = $con->prepare("CALL add_merch_type(?, ?)");
    $stmt->bind_param("is", $merch_id, $merch_type);
    $stmt->execute();

    if($stmt->affected_rows > 0)
    {
        echo "<script>alert('New Merchandise Type successfully added!');</script>";
        echo "<script>document.location = 'merchtype-index.php';</script>";
    }
    else
    {
...
<html lang="en">
  ...
  <body>
    ...
    <div class='profile_form' class="container d-flex justify-content-center"  class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            ...
            <h2>Merchandise Type Information</h2>    
            <div class='form_group' class="row mb-3">
                    
                    <div class="col">
                        <label class="form-label">Merchandise ID</label>
                        <input type="text" class="form-control" name="merch_id" placeholder="01">
                    </div>

                    <div class="col">
                        <label class="form-label">Merchandise Type</label>
                        <input type="text" class="form-control" name="merch_type" placeholder="Food & Drinks">
                    </div>
                ...
                <div class='form_buttons'>
                    ...
                    <button>
                    <a class='cancel' href="merchtype-index.php" class="btn btn-danger">View Records</a>
                    </button>
                </div>
