...
{
    $did = $_GET['delid'];
    $sql = mysqli_query($con,"DELETE FROM `concession_space` WHERE  space_id = '$did'");

    echo "<script>alert('Deleted successfully!');</script>";
    echo "<script>window.location='conspace-index.php';</script>";
}
...
<html lang="en">
    ...
    <div> 
        ...
        <div class="row">
            <div class="col-md-12">
                <div>
                <form action="conspace-index.php" method="post" style="margin-top:50px;">
                    <input
                        type="text"
                    ...
                    <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $sql = "SELECT * FROM concession_space WHERE space_id LIKE ?";
                                ...
                                echo '<table class="table table-bordered table-striped">';
                                    ...
                                    while($row = $result->fetch_array()){
                                        echo "<tr>";
                                            ...
                                            echo "<td>" . $row['date_rented'] . "</td>";
                                            echo "<td>" . $row['status'] . "</td>";
                                            echo "<td>" . $row['merch_type'] . "</td>";
                                            echo "<td>" . $row['price'] . "</td>";
                                            echo "<td>";
                                                echo '<a href="conspace-edit.php?id='. $row['space_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                                echo '<a href="conspace-index.php?id='. $row['space_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";                            
                ...
                <h2 class="pull-left">Rents</h2>
                <a href="conspace-add_new.php" class="btn btn-info pull-right" style="padding:10px; color: white;"><i class="fa fa-plus" style="font-size: 18px;"></i> Create Space</a>
            </div>
        </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                        ...
                        <tbody>
                            <?php
                                require_once "config.php";
                                $sql = mysqli_query($con, "SELECT * FROM `concession_space`");
                                    $count = 1;
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="conspace-edit.php?editid=<?php echo htmlentities($row['space_id']);?>" class="link-dark" class="mr-3" title="Update Record" data-toggle="tooltip"><span style="font-size: 23px; color: #00ACC1;" class="fa fa-pencil"></span></a>
                                    <a href="conspace-index.php?delid=<?php echo htmlentities($row['space_id']);?>" class="link-dark" title="Delete Record" data-toggle="tooltip"><span style="font-size: 23px; color: #00ACC1;" class="fa fa-trash"></span></a>
                                </td>
                            </tr>
                            <?php
                                        $count = $count+1;
