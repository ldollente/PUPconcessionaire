    ...
    <div class="wrapper" style="padding-left: 85px; padding-right: 85px;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                <div>
                <form action="student-accounts.php" method="post"  style="margin-top:50px;">
                    <input
                        type="text"
                        placeholder="Search student's account"
                        name="search"
                        required>
                    ...
                    <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $sql = "SELECT * FROM student_login WHERE username LIKE ? or fullname LIKE ?";
                                ...
                                echo '<table class="table table-bordered table-striped">';
                                    ...
                                    while($row = $result->fetch_array()){
                                        echo "<tr>";
                                            ...
                                            echo "<td>";
                                                echo '<a href="delete-student-account.php?id='. $row['stud_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";                            
                ...
                <div class="mt-5 mb-3 clearfix" style="padding:10px">
                    ...
                    <a href="register-student-account.php" class="btn btn-info pull-right" style="padding:10px"><i class="fa fa-plus"></i> Create Account</a>
                </div>
                <?php
                // Include config file
                require_once "config.php";
                    ...
                    if($result->num_rows > 0){
                        echo '<table class="table table-bordered table-light table-striped" style="padding:10px">';
                            ...
                            while($row = $result->fetch_array()){
                                ...
                                echo "<td>" . $row['username'] . "</td>";
                                    echo "<td>";
                                        echo '<a href="delete-student-account.php?id='. $row['stud_id'] .'" title="Delete Record" data-toggle="tooltip"><span style="font-size: 23px; color: #00ACC1;" class="fa fa-trash"></span></a>';
                                    echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";                            
