    ...
    <div class="wrapper" style="padding-left: 85px; padding-right: 85px;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                <div>
                <form action="student-list.php" method="post" style="margin-top:50px;">
                    <input
                        type="text"
                    ...
                    <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $sql = "SELECT * FROM student WHERE stud_id LIKE ? or fullname LIKE ?";
                                ...
                                echo '<table class="table table-bordered table-striped">';
                                    ...
                                    while($row = $result->fetch_array()){
                                        echo "<tr>";
                                            ...
                                            echo "<td>";
                                                echo '<a href="update-client.php?id='. $row['stud_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                                echo '<a href="delete-student.php?id='. $row['stud_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";                            
                ...
                <div class="mt-5 mb-3 clearfix" style="padding:10px">
                    ...
                    <a href="register-student.php" class="btn btn-info pull-right" style="padding:10px"><i class="fa fa-plus"></i> Create Student</a>
                    <a href="student-accounts.php" id="archive" class="btn btn-info pull-right" style="padding: 10px; color: white;"><i class="fa fa-archive fa-lg"></i> Student Login</a>
                </div>
                    ...
                    if($result->num_rows > 0){
                        echo '<table class="table table-bordered table-light table-striped text-center" style="padding:10px">';
                            ...
                            while($row = $result->fetch_array()){
                                ...
                                echo "<td>" . $row['address'] . "</td>";
                                    echo "<td>";
                                        echo '<a href="update-student.php?id='. $row['stud_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span style="font-size: 23px; color: #00ACC1;" class="fa fa-pencil"></span></a>';
                                        echo '<a href="delete-student.php?id='. $row['stud_id'] .'" title="Delete Record" data-toggle="tooltip"><span style="font-size: 23px; color: #00ACC1;" class="fa fa-trash"></span></a>';
                                    echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";                            
